# This is code from the tutorial found at: funkey.science/gunpowder/tutorial_simple_pipeline.html
...
# define a "random" number so my results match the tutorial
...
# store the image in zarr container
...
# Call imshow() to display the raw image that we're working with.
...
request = gp.BatchRequest()
request[raw] = gp.Roi((0,0), (512,512)) # Size of the whole image
...
# Solution:
#   -> GP was made to work with arbitrarily large nD arrays
